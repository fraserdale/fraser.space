...
if(isset($_POST['submit'])):
    ...
    if(isset($_POST['g-recaptcha-response']) && !empty($_POST['g-recaptcha-response'])):
        ...
        $secret = '6LehLBYUAAAAAA7wVaK51xXohkY-m7MW2m8qCvTa';
        ...
        if($responseData->success):
            ...
            $succMsg = '<strong>Your contact request has submitted successfully.</strong>';
			$name = '';
			$email = '';
			$message = '';
			        else:

            $errMsg = '<strong>Robot verification failed, please try again.</strong>';
	           endif;

    else:
        $errMsg = '<strong>Please click on the reCAPTCHA box.</strong>';
	    endif;
                ...
                <div class="collapse navbar-collapse text-center" id="bs-example-navbar-collapse-1">
                    ...
                    <div class="social-media hidden-sm hidden-xs">
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li><a href="/captcha/index.php"><i class="fa fa-facebook"></i></a></li>
        ...
        <div id="owl-hero" class="owl-carousel owl-theme">
            ...
            <div class="item" style="background-image: url(img/sliders/Slide3.jpg)">
                ...
                <div class="caption">
                    ...
                    <h1>Droplet <span>Increase</span></h1>
...
<div class="form-group">
				<input type="text" class="text form-control" value="<?php echo !empty($name)?$name:''; ?>" placeholder="Your full name" name="name" required="">
</div>
<div class="form-group">
                <input type="text" class="text form-control" value="<?php echo !empty($email)?$email:''; ?>" placeholder="Email adress" name="email" required="" >
</div>
<div class="form-group"  style="width 500px">
                <textarea id="textbox" type="text" class="form-control" placeholder="Message..." required="" name="message"><?php echo !empty($message)?$message:''; ?></textarea>
</div>

<div>
<div class="g-recaptcha" data-sitekey="6LehLBYUAAAAAPQ_zMVIOvqlvBNMG8AiHC9dG9d2" style="transform:scale(0.77);-webkit-transform:scale(0.77);transform-origin:0 0;-webkit-transform-origin:0 0; float: left; width: 50%;"> </div>
<input type="submit"  class="btn-block" id="submit" name="submit" value="SUBMIT">
</div>
